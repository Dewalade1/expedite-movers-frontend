...
export default function AboutUsContent () {
    return(
        <div className="black-bg-layout">
            <div className="section-wrapper about-us-container">
            ...
            <div className="section-wrapper about-us-container">
                <div className="about-us-info">
                    ...
                    At Expedite Movers, our customers are our family so we treat them with the best of attentions. Our customer service is available to swiftly attend to you and all your needs.
                </div>
                <div className="about-us-img-container">
